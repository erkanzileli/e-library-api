...
public class BookTest {
	...
	private User user = new User("editor", "password", "firstname", "lastname", "email", "type", 1, false);
	...
	public void testUpdateBookWithManager() {
		...
		User newUser = new User("editor2", "password2", "firstname", "lastname", "email", "type", 1, false);
		BookCategory newBookCategory = new BookCategory("Drama");
		boolean result = book.updateBook(tokenAdmin, newname, newTitle, newDescription, newPageCount, newAuthor,
				newUser, newBookCategory);
		assertTrue(result);
	...
	public void testUpdateBookWithSelfUser() {
		...
		User newUser = null;
		BookCategory newBookCategory = new BookCategory("Drama");
		boolean result = book.updateBook(tokenEditor, newname, newTitle, newDescription, newPageCount, newAuthor,
				newUser, newBookCategory);
		assertTrue(result);
		assertEquals(newname, book.getName());
		assertEquals(newTitle, book.getTitle());
	...
	public void testUpdateBookWithAnotherUser() {
		...
		User newUser = null;
		BookCategory newBookCategory = new BookCategory("Drama");
		boolean result = book.updateBook(tokenAnother, newname, newTitle, newDescription, newPageCount, newAuthor,
				newUser, newBookCategory);
		assertFalse(result);
